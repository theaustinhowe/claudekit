-- Gadget Initial Schema
-- All tables, indexes, and sequences
...
CREATE INDEX IF NOT EXISTS idx_fix_actions_repo ON fix_actions(repo_id);
...
CREATE INDEX IF NOT EXISTS idx_concept_sources_type ON concept_sources(source_type);
...
CREATE INDEX IF NOT EXISTS idx_generator_projects_status ON generator_projects(status);
...
CREATE INDEX IF NOT EXISTS idx_ui_specs_project ON ui_specs(project_id);
...
CREATE INDEX IF NOT EXISTS idx_mock_data_sets_project ON mock_data_sets(project_id);
...
CREATE INDEX IF NOT EXISTS idx_spec_snapshots_project ON spec_snapshots(project_id);
