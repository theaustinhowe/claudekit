              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      This will immediately terminate the agent process. The job will be <strong>paused</strong> and you
                      can resume it later, but the session will not be saved so the agent will start fresh. Use this
                      when the agent is doing something wrong and you want to stop it quickly.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Keep Running</AlertDialogCancel>
                ...
                {events.length === 0 ? (
                  ...
                  <div className="space-y-1">
                    {events.map((event, index) => {
                      ...
                      const isRunStart = isStateChange && (event.toStatus === "running" || event.toStatus === "queued");
